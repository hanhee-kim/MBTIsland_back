...
import com.kosta.mbtisland.config.oauth2.OAuth2LoginSuccessHandler;
import com.kosta.mbtisland.config.oauth2.PrincipalOauth2UserService;
...
//		.antMatchers("/user/**").access("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
		.antMatchers("/guest/**").access("hasRole('ROLE_GUEST') or hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
